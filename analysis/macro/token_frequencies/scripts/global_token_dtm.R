...
# set output path:
output_file <- "C:/Users/Philipp/Desktop/Digital Humanities/2. Semester/Projektarbeit/token_frequencies/length_in_tokens/document_term_matrix/DTM.xlsx"
...
# set output path
output_file_merged <- "C:/Users/Philipp/Desktop/Digital Humanities/2. Semester/Projektarbeit/token_frequencies/length_in_tokens/document_term_matrix/DTM_merged.xlsx"
