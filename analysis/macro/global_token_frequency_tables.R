...
# set output path
output_folder <- "C:/Users/Philipp/Desktop/Digital Humanities/2. Semester/Projektarbeit/token_frequencies/length_in_tokens/frequency_tables"
